...
| [Agentic Development](agentic-development/index.md) | The framework for repository-addressable organization documentation that gives agents project-specific standards and behavior. |
