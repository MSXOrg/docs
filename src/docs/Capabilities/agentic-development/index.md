...
description: The framework for repository-addressable organization documentation that gives agents project-specific standards and behavior.
---

# Agentic Development

The Agentic Development framework makes an organization the operating boundary for human and agent work. Each organization identifies the repository that owns its canonical knowledge; every product repository carries a short router that names the applicable sources and keeps its own nuance in the files a human already reads.
