...
- **Author is not approver.** A change is never approved by the identity that wrote it; GitHub enforces this for people, and it holds for agents — an agent that authored a pull request cannot approve it.
